...
func (db *DB) InsertAccount(ctx context.Context, name string, refreshToken string, proxyURL string) (int64, error) {
	...
	return db.insertRowID(ctx,
		`INSERT INTO accounts (name, type, credentials, proxy_url) VALUES ($1, 'oauth', $2, $3) RETURNING id`,
		`INSERT INTO accounts (name, type, credentials, proxy_url) VALUES ($1, 'oauth', $2, $3)`,
...
func (db *DB) InsertATAccount(ctx context.Context, name string, accessToken string, proxyURL string) (int64, error) {
	...
	return db.insertRowID(ctx,
		`INSERT INTO accounts (name, type, credentials, proxy_url) VALUES ($1, 'access_token', $2, $3) RETURNING id`,
		`INSERT INTO accounts (name, type, credentials, proxy_url) VALUES ($1, 'access_token', $2, $3)`,
		name, credJSON, proxyURL,
	)
}
